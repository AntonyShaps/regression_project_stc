...
filtered <- west_austria[west_austria$py090n != 0, ]

plot(filtered$age, filtered$py090n, 
     col = "blue",
     pch = 16, 
     main = "Net Income vs Age", 
     xlab = "Age", 
     ylab = "Net Income")
abline(lm(py090n ~ age, data = filtered), col = "red")
```
...
plot(filtered$hsize, filtered$py090n, 
     col = "red", 
     pch = 16, 
     main = "Net Income vs Household Size", 
     xlab = "Household Size", 
     ylab = "Net Income")
abline(lm(py090n ~ hsize, data = filtered), col = "blue")
```
