...
# Reset the plotting area to default (1 plot per page)
par(mfrow = c(1, 1))
...
boxcox_model has adjusted R-squared of `r adj_r2_model1` compared to `r adj_r2_model2` of full_boxcox_model, which makes model with additional transformations of independent variables redundant, as it both more complex and less accurate.
